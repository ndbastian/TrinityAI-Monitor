...
dataset_dirpath    = "/workspace/aroy/datasets/coco_ooc/OOC_images/animal_in_indoor/images"
annotation_dirpath = "/workspace/aroy/datasets/coco_ooc/OOC_images/animal_in_indoor/annotations"
...
sel_animal_ids = {'giraffe': 25, 'zebra': 24, 'bear': 23, 'elephant': 22, 'cow': 21, 'sheep': 20,
                  'horse': 19, 'bird': 16, }
patch_obj_ids = sel_animal_ids
            ...
            for ann_j_indx, single_id_j in enumerate(ann_ids_j):
                ...
                if category_id_j in list(patch_obj_ids.values()):  # outdoor object
                    ...
                    if not dim_error_flag:
                        ...
                        ooc_filename = f"{ori_img_name}_var1_{j}_{ann_j_indx}.jpg"
