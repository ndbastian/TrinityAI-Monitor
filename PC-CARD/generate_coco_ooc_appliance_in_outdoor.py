...
dataset_dirpath    = "/workspace/aroy/datasets/coco_ooc/OOC_images/appliance_in_outdoor/images"
annotation_dirpath = "/workspace/aroy/datasets/coco_ooc/OOC_images/appliance_in_outdoor/annotations"
...
outdoor_wo_person_ids = {**sport_ids, **outdoor_accessory_ids, **animal_ids, **outdoor_object_ids, **vehicle_ids,} 
scene_obj_ids = outdoor_wo_person_ids
sel_appliance_ids = {'refrigerator': 82, 'toaster': 80, 'oven': 79, 'microwave': 78, }
patch_obj_ids = sel_appliance_ids
...
# hyper parameters
# patch size range
patch_width_range = (120, 160)

# location
location_r_range = (200, 250)
location_c_range = (20, 300)
...
for i, batch in enumerate(dataset):
    ...
    for single_id in ann_ids:
        ...
        if category_id in scene_obj_ids.values():  # outdoor image
            i_select_flag = True
    ...
    if i_select_flag:
        ...
        for j, batch_j in enumerate(dataset):
            ...
            for ann_j_indx, single_id_j in enumerate(ann_ids_j):
                ...
                if category_id_j in list(patch_obj_ids.values()):  # furniture object
                    sel_fname_j = fname_j
                    sel_fpath_j = fpath_j
                    ...
                    if not dim_error_flag:
                        ...
                        ooc_filename = f"{ori_img_name}_var2_{j}_{ann_j_indx}.jpg"
