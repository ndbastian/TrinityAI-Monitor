...
dataset_dirpath    = "/workspace/aroy/datasets/coco_ooc/OOC_images/food_in_outdoor/images"
annotation_dirpath = "/workspace/aroy/datasets/coco_ooc/OOC_images/food_in_outdoor/annotations"
            ...
            for ann_j_indx, single_id_j in enumerate(ann_ids_j):
                ...
                if category_id_j in list(patch_obj_ids.values()):  # furniture object
                    ...
                    if not dim_error_flag:
                        ...
                        ooc_filename = f"{ori_img_name}_var4_{j}_{ann_j_indx}.jpg"
