...
dataset_dirpath    = "/workspace/aroy/datasets/coco_ooc/OOC_images/outdoor_object_in_indoor/images"
annotation_dirpath = "/workspace/aroy/datasets/coco_ooc/OOC_images/outdoor_object_in_indoor/annotations"
...
scene_obj_ids = indoor_ids

sel_outdoor_object_ids = {'parking meter': 14, 'stop sign': 13, 'fire hydrant': 11, 'traffic light': 10, }
patch_obj_ids = sel_outdoor_object_ids
            ...
            for ann_j_indx, single_id_j in enumerate(ann_ids_j):
                ...
                if category_id_j in list(patch_obj_ids.values()):  # outdoor object
                    ...
                    if not dim_error_flag:
                        ...
                        ooc_filename = f"{ori_img_name}_var5_{j}_{ann_j_indx}.jpg"
