...
dataset_dirpath    = "/workspace/aroy/datasets/coco_ooc/OOC_images/indoor_big/images"
annotation_dirpath = "/workspace/aroy/datasets/coco_ooc/OOC_images/indoor_big/annotations"
...
sel_electronic_ids = {'cell phone': 77, 'keyboard': 76,  'remote': 75,  'mouse': 74, 'laptop': 73}
sel_kitchen_ids = {'bowl': 51, 'spoon': 50, 'knife': 49, 'fork': 48, 'cup': 47, 'wine glass': 46, 'bottle': 44,}

patch_obj_ids = {**sel_electronic_ids, **sel_kitchen_ids}
            ...
            for ann_j_indx, single_id_j in enumerate(ann_ids_j):
                ...
                if category_id_j in list(patch_obj_ids.values()):  # outdoor object
                    ...
                    if not dim_error_flag:
                        ...
                        ooc_filename = f"{ori_img_name}_indoor_big_var_{j}_{ann_j_indx}.jpg"
